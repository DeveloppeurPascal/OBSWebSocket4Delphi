# Librairie cliente Delphi pour l'API WebSocket d'OBS Studio

[This page in English.](README.md)

Client WebSocket donnant accès à l'API de OBS Studio dans vos projets Delphi.
...
Pour télécharger ce dépôt de code il est recommandé de passer par "git" mais vous pouvez aussi télécharger un ZIP directement depuis [son dépôt GitHub](https://github.com/DeveloppeurPascal/OBSWebSocket4Delphi).

Ce projet utilise des dépendances sous forme de sous modules. Ils seront absents du fichier ZIP. Vous devrez les télécharger à la main.

* [obsproject/obs-websocket](https://github.com/obsproject/obs-websocket) doit être installé dans le sous dossier ./lib-externes/obs-websocket
...
L'export de la documentation est fait en HTML par [DocInsight](https://devjetsoftware.com/products/documentation-insight/) ou [PasDoc](https://pasdoc.github.io) vers le dossier /docs du dépôt. Vous y avez aussi [accès en ligne](https://developpeurpascal.github.io/OBSWebSocket4Delphi) grâce à l'hébergement offert par GitHub Pages.

D'autres informations (tutoriels, articles, vidéos, FAQ, présentations et liens) sont disponibles sur [le site web du projet](https://obswebsocket4delphi.developpeur-pascal.fr/) ou [le devlog du projet](https://developpeur-pascal.fr/client-delphi-pour-l-api-websocket-de-obs-studio.html).
...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://github.com/DeveloppeurPascal/OBSWebSocket4Delphi/issues) pour que je teste et tente de corriger ou fournir un contournement.
...
Si cette licence ne convient pas à vos besoins (notamment pour un projet commercial) je propose aussi [des licences classiques pour les développeurs et les entreprises](https://obswebsocket4delphi.developpeur-pascal.fr/).
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://github.com/DeveloppeurPascal/OBSWebSocket4Delphi) et [d'ouvrir un ticket](https://github.com/DeveloppeurPascal/OBSWebSocket4Delphi/issues).
